...
import { AddFileForm } from "../Documents/AddFile.styles";
...
const NewAppointment = ({ closeModal }) => {
  ...
  return (
    <Modal situation="adaptHeight">
      ...
      <AddFileForm id="appointmentForm">
        <InputLabel>
          Name
          <InputText
            name="name"
        ...
        <InputLabel>
          ...
          <InputText
            onChange={(e) =>
              setForm({ ...form, date: stringDateToISO(e.target.value) })
            }
            name="date"
            type="date"
          />
        ...
        {form.isRegular && (
          <InputLabel>
            ...
            <InputText
              ...
              placeholder="ex. 2"
              type="number"
              onInput={(e) => setForm({ ...form, regularity: e.target.value })}
            />
            months
          </InputLabel>
        )}
